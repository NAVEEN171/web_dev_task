    ...
    return  (  
        <div className='Home-container z-index:5 w-full relative  h-screen md:flex-row flex flex-col items-center md:items-start  '>
                    ...
                    <div className='flex flex-col '>
                        ...
                        <div onClick={() => { setshow(!show) }} className='drop-down  hover:bg-gray-100 mt-[20px] cursor-pointer  relative w-full rounded-md py-[5px] px-[10px] flex gap-[10px] justify-between items-center border border-[ #D6D7DA]'>
                            ...
                            {show && <div className='absolute  top-full mt-[4px] left-0 absolute z-10 w-full mt-1 bg-white rounded-lg shadow-lg border border-gray-20'>
                                {
                                    users.map((user,idx) => (
                                        <div key={idx} onClick={() => { setshow(false); setcurrentUser(user) }} className='text-left py-[5px] pl-[10px]'>{user}</div>
                                    ))
                                }
                            </div>}
                        </div>
            ...
            <div className={`main-content w-full h-[calc(100%-64px)] md:h-full md:w-[calc(100%-240px)] flex justify-center items-center  bg-white ${opennavbar ? ' pointer-events-none' : ''}`}>
                <div className='xs:w-[100%] w-[95%] h-[95%] rounded-xl border border-[rgba(233, 234, 235, 1)]'>
                        ...
                        <div className='xs:w-[92%] w-[95%] flex flex-col gap-[15px]'>
                            <div className='repos-header xs:flex-col xs:gap-[12px] xs:items-start flex flex-row justify-between items-center  '>
                                ...
                                <div className='flex gap-[12px] '>
                                    <button onClick={() => { setrepoactive("Refresh All") }} className={`${repoactive === "Refresh All" ? 'bg-button-color text-white   ' : 'border-[rgba(233, 234, 235, 1)]'} flex gap-[10px] py-[10px] font-normal font-inter text-[14px] border  leading-[20px] rounded-md px-[14px] items-center`}>
                                    ...
                                    <button onClick={() => { setrepoactive("Add Repository") }} className={`${repoactive === "Add Repository" ? 'bg-button-color text-white ' : ''} flex gap-[10px] py-[10px] font-normal font-inter text-[14px] border border-[rgba(233, 234, 235, 1)] leading-[20px] rounded-md px-[14px] items-center`}>
